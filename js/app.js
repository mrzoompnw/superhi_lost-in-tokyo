...
const Intro = () => (
  <div className="m-auto-ns f4 f3-m f2-l tc w-80-l normal cursor-defualt">
...
const NavItem = ({ href, className, children, logo }) => (
  ...
  >
    <div>
      <h1 className="f4 f3-ns mt0 mb2 regular black normal lh-title">
        {link ? (
          <a className="no-underline" target="_blank" href={link}>
            {title}
          </a>
        ) : (
          title
